...
impl fmt::Display for Model {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            Model::LibraColour   => write!(f, "Kobo Libra Colour"),
            Model::ClaraColour   => write!(f, "Kobo Clara Colour"),
            Model::ClaraBW       => write!(f, "Kobo Clara BW"),
            Model::Elipsa2E      => write!(f, "Kobo Elipsa 2E"),
            Model::Clara2E       => write!(f, "Kobo Clara 2E"),
            Model::Libra2        => write!(f, "Kobo Libra 2"),
            Model::Sage          => write!(f, "Kobo Sage"),
            Model::Elipsa        => write!(f, "Kobo Elipsa"),
            Model::Nia           => write!(f, "Kobo Nia"),
            Model::LibraH2O      => write!(f, "Kobo Libra H₂O"),
            Model::Forma32GB     => write!(f, "Kobo Forma 32GB"),
            Model::Forma         => write!(f, "Kobo Forma"),
            Model::ClaraHD       => write!(f, "Kobo Clara HD"),
            Model::AuraH2OEd2V1  => write!(f, "Kobo Aura H₂O Edition 2 Version 1"),
            Model::AuraH2OEd2V2  => write!(f, "Kobo Aura H₂O Edition 2 Version 2"),
            Model::AuraEd2V1     => write!(f, "Kobo Aura Edition 2 Version 1"),
            Model::AuraEd2V2     => write!(f, "Kobo Aura Edition 2 Version 2"),
            Model::AuraONELimEd  => write!(f, "Kobo Aura ONE Limited Edition"),
            Model::AuraONE       => write!(f, "Kobo Aura ONE"),
            Model::Touch2        => write!(f, "Kobo Touch 2.0"),
            Model::GloHD         => write!(f, "Kobo Glo HD"),
            Model::AuraH2O       => write!(f, "Kobo Aura H₂O"),
            Model::Aura          => write!(f, "Kobo Aura"),
            Model::AuraHD        => write!(f, "Kobo Aura HD"),
            Model::Mini          => write!(f, "Kobo Mini"),
            Model::Glo           => write!(f, "Kobo Glo"),
            Model::TouchC        => write!(f, "Kobo Touch C"),
            Model::TouchAB       => write!(f, "Kobo Touch A/B"),
