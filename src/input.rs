...
mod tests {
    use crate::input::{
        button_scheme_event, display_rotate_event, ButtonCode, ButtonStatus, EV_KEY, KEY_BACKWARD,
        KEY_BUTTON_SCHEME, KEY_FORWARD, KEY_HOME, KEY_LIGHT, KEY_POWER, KEY_ROTATE_DISPLAY,
